              ...
              <Card className="bg-white p-2 w-full h-80 sm:h-[58vh]">
                <CardHeader>
                  ...
                  <CardDescription className="text-gray-500 w-full flex flex-col">
                    Pedidos feitos
                    <div className="flex flex-row lg:justify-between pr-2 pt-2 lg:space-x-1">
                      ...
                      <input
                        ...
                        className="bg-gray-200 rounded-lg pl-2 outline-violet-600 lg:w-40 h-8 sm:w-52 sm:h-auto"
                      />
                    </div>
                  </CardDescription>
                </CardHeader>
